...
import '../state_managers_controller/delete_task_controller.dart';
import '../state_managers_controller/get_task_controller.dart';
import '../state_managers_controller/summary_count_controller.dart';
...
class _NewTaskScreenState extends State<NewTaskScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      _getTasksController.getTasks(ApiUrls.newTasks).then((value) {
        if (value == false) {
          Get.snackbar(
            'Failed',
      ...
      builder: (context) {
        return UpdateTaskStatusSheet(
            ...
            onUpdate: () {
              ...
              _getTasksController.getTasks(ApiUrls.newTasks);
            });
      },
    );
  }
